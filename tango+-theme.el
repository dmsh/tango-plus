...
(deftheme tango+ "A color theme based on Tango Palette.")
...
(with-tango-palette
 (custom-theme-set-faces
  ...
  `(cursor ((t (:background ,butter1))))
  `(default ((t (:foreground ,aluminium2 :background ,aluminium6))))
  ...
  `(mode-line ((t (:foreground ,aluminium6 :background ,skyblue1 :weight bold :box (:line-width -1 :color ,skyblue1)))))
  `(mode-line-buffer-id ((t nil)))
  ;; `(mode-line-emphasis ((t (nil))))
  `(mode-line-highlight ((t (:box nil))))
  `(mode-line-inactive ((t (:foreground ,aluminium2 :background ,aluminium5 :weight bold :box (:line-width -1 :color ,aluminium5)))))
  ;; `(mouse ((t (nil))))
  ;; `(next-error ((t (nil))))
  ;; `(nobreak-space ((t (nil))))
  ;; `(query-replace ((t (nil))))
  ...
  ;; `(a-defface                                           ((t (nil))))
  ;; `(cogre-box-face                                      ((t (nil))))
  ;; `(cogre-box-first-face                                ((t (nil))))
  ;; `(cogre-box-last-face                                 ((t (nil))))
  ;; `(eieio-custom-slot-tag-face                          ((t (nil))))
  ;; `(linemark-caution-face                               ((t (nil))))
  ;; `(linemark-funny-face                                 ((t (nil))))
  ;; `(linemark-go-face                                    ((t (nil))))
  ;; `(linemark-stop-face                                  ((t (nil))))
  ...
  ;; `(semantic-regtest-reference-button-face              ((t (nil))))
  ;; `(semantic-regtest-test-button-face                   ((t (nil))))
  ;; `(semantic-tag-boundary-face                          ((t (nil))))
  ;; `(semantic-tag-folding-fringe-face                    ((t (nil))))
  ...
  `(custom-button ((t (:foreground ,aluminium2 :background ,aluminium5 :box (:line-width 1 :style released-button)))))
  ...
  ;; `(wl-highlight-action-argument-face                ((t (nil))))
  `(wl-highlight-demo-face                           ((t (nil))))
  ;; `(wl-highlight-folder-closed-face                  ((t (nil))))
  ;; `(wl-highlight-folder-few-face                     ((t (nil))))
  ;; `(wl-highlight-folder-killed-face                  ((t (nil))))
  ;; `(wl-highlight-folder-many-face                    ((t (nil))))
  ;; `(wl-highlight-folder-opened-face                  ((t (nil))))
  ...
  ;; `(wl-highlight-header-separator-face               ((t (nil))))
  ;; `(wl-highlight-logo-face                           ((t (nil))))
  ;; `(wl-highlight-message-citation-header             ((t (nil))))
  ;; `(wl-highlight-message-cited-text-1                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-10               ((t (nil))))
  ;; `(wl-highlight-message-cited-text-2                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-3                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-4                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-5                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-6                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-7                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-8                ((t (nil))))
  ;; `(wl-highlight-message-cited-text-9                ((t (nil))))
  ;; `(wl-highlight-message-header-contents             ((t (nil))))
  ;; `(wl-highlight-message-headers                     ((t (nil))))
  ...
  ;; `(wl-highlight-summary-copied-face                 ((t (nil))))
  ;; `(wl-highlight-summary-deleted-face                ((t (nil))))
  ;; `(wl-highlight-summary-displaying-face             ((t (nil))))
  ;; `(wl-highlight-summary-disposed-face               ((t (nil))))
  ;; `(wl-highlight-summary-flagged-face                ((t (nil))))
  ;; `(wl-highlight-summary-forwarded-face              ((t (nil))))
  ;; `(wl-highlight-summary-high-read-face              ((t (nil))))
  ;; `(wl-highlight-summary-high-unread-face            ((t (nil))))
  ;; `(wl-highlight-summary-important-flag-face         ((t (nil))))
  ;; `(wl-highlight-summary-killed-face                 ((t (nil))))
  ;; `(wl-highlight-summary-low-read-face               ((t (nil))))
  ;; `(wl-highlight-summary-low-unread-face             ((t (nil))))
  ;; `(wl-highlight-summary-new-face                    ((t (nil))))
  ;; `(wl-highlight-summary-normal-face                 ((t (nil))))
  ;; `(wl-highlight-summary-prefetch-face               ((t (nil))))
  ;; `(wl-highlight-summary-refiled-face                ((t (nil))))
  ;; `(wl-highlight-summary-resend-face                 ((t (nil))))
  ;; `(wl-highlight-summary-target-face                 ((t (nil))))
  ;; `(wl-highlight-summary-temp-face                   ((t (nil))))
  ;; `(wl-highlight-summary-thread-top-face             ((t (nil))))
  ;; `(wl-highlight-summary-unread-face                 ((t (nil))))
